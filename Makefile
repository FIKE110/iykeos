...
$(BUILD_DIR)/tinybasic.o: $(PROGS_DIR)/TINYBASIC.c
	@echo "  CC      $<"
	@$(CC) $(CFLAGS) -c $< -o $@
...
$(BUILD_DIR)/tinybasic.elf: $(BUILD_DIR)/code_entry.o $(BUILD_DIR)/tinybasic.o
	@echo "  LD      tinybasic.elf"
	@$(LD) $(LDFLAGS2) $^ -o $@
